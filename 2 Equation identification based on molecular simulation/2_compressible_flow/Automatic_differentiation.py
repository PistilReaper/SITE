...
if __name__ == "__main__": 
    ...
    train_data = np.loadtxt('data/TecGrid-Cavity_Kn0.005_Ma1.0_nloop400000000.dat', delimiter=' ', skiprows = 3)
    x = train_data[:,0:1]
    y = train_data[:,1:2]
    u = train_data[:,3:4]
    v = train_data[:,4:5]
    ...
    scio.savemat('data/gradients_Cavity_Kn0.005_Ma1.0_nloop400000000.mat', {'x':x,'y':y,'u':u,'v':v, 'u_x':u_x, 'u_y':u_y, 'v_x':v_x, 'v_y':v_y
                                                                })
