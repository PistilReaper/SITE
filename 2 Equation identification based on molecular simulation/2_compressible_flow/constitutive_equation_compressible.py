...
# %%
miu_ref = 2.117e-5 # Viscosity coefficient
T_ref = 273.15
...
T = target_data[:,6:7]
p = n_rho * k * T
# VHS viscosity correction
miu = miu_ref * (T/T_ref)**0.81
...
plasmid_pset = gep.PrimitiveSet('Plasmid', input_names=['p','D_kk','miu'])
...
output_type = 'compressible'     # Name of the problem
